...
#define Time time.x// Same as Globals.GameTime, unless not in world.
...
// Uses SmoothBlockLight to dim stars when in lit areas, depending on PhotosensitiveMode; Used in <somnium_reale:stars.fsh>, <somnium_reale:stars_tiny.fsh>, <somnium_reale:stars_big.fsh>
...
// Uses SmoothTime to twinkle stars, depending on PhotosensitiveMode; Used in <somnium_reale:stars.fsh>, <somnium_reale:stars_tiny.fsh>
