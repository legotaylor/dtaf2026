...
public class SupportedFenceGateBlock extends SupportedHorizontalFacingBlock {
	public static final BooleanProperty OPEN = Properties.OPEN;
	public static final BooleanProperty POWERED = Properties.POWERED;
	public static final BooleanProperty IN_WALL = Properties.IN_WALL;
	public static final MapCodec<SupportedFenceGateBlock> codec = RecordCodecBuilder.mapCodec(
		instance -> instance.group(
				WoodType.CODEC.fieldOf("type").forGetter(block -> block.type),
				TagKey.codec(RegistryKeys.BLOCK).fieldOf("isOf").forGetter(block -> block.isOf),
				createSettingsCodec()
			)
			.apply(instance, SupportedFenceGateBlock::new)
	);
	...
	public SupportedFenceGateBlock(WoodType type, TagKey<Block> idOf, AbstractBlock.Settings settings) {
		super(idOf, settings.sounds(type.soundType()));
		this.type = type;
	...
	@Override
	public MapCodec<? extends SupportedFenceGateBlock> getCodec() {
		return codec;
	}
	...
	protected BlockState getStateForNeighborUpdate(BlockState state, WorldView world, ScheduledTickView tickView, BlockPos pos, Direction direction, BlockPos neighborPos, BlockState neighborState, Random random) {
		...
		if (canWallConnect(state, state.get(facing))) {
