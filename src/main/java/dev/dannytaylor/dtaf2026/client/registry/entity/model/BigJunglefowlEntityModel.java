...
public class BigJunglefowlEntityModel extends AbstractJunglefowlEntityModel {
	public BigJunglefowlEntityModel(ModelPart root) {
		super(root);
	}
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData head = modelPartData.addChild("head", ModelPartBuilder.create().uv(24, 0).cuboid(-2.0F, -4.0F, -2.5F, 4.0F, 6.0F, 3.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 13.0F, -3.5F));
		...
		ModelPartData body = modelPartData.addChild("body", ModelPartBuilder.create().uv(0, 0).cuboid(-3.0F, -4.0F, -5.0F, 6.0F, 8.0F, 6.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 13.0F, 0.0F, 1.4617F, 0.0F, 0.0F));
		...
		modelPartData.addChild("left_wing", ModelPartBuilder.create().uv(12, 14).cuboid(0.0F, 1.0F, -3.0F, 1.0F, 4.0F, 6.0F, new Dilation(0.0F)), ModelTransform.of(3.0F, 12.0F, 0.0F, -0.1091F, 0.0F, 0.0F));
		modelPartData.addChild("right_wing", ModelPartBuilder.create().uv(12, 14).cuboid(-1.0F, 1.0F, -3.0F, 1.0F, 4.0F, 6.0F, new Dilation(0.0F)), ModelTransform.of(-3.0F, 12.0F, 0.0F, -0.1091F, 0.0F, 0.0F));
